...
public final class DirectDealDao {
    ...
    private void setDealParams(PreparedStatement ps, DirectDeal d, ScoreBreakdown s) throws SQLException {
        ...
        JdbcSupport.setString(ps, 37, d.assetClassPm());
        ...
        JdbcSupport.setString(ps, 42, d.vehicleType());
        JdbcSupport.setString(ps, 43, d.lifecycleStage());
        JdbcSupport.setString(ps, 44, d.sectorFocus());
    }
